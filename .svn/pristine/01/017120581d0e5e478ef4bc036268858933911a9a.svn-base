...
public class XzhqhUtils {
	...
	static{
		...
		XZQHMAP.put("410181", "410181");
		XZQHMAP.put("410225", "410225");
		XZQHMAP.put("410482", "410482");
		XZQHMAP.put("410526", "410526");
		XZQHMAP.put("410728", "410728");
		XZQHMAP.put("411381", "411381");
		XZQHMAP.put("411481", "411481");
		XZQHMAP.put("411525", "411525");
		XZQHMAP.put("411628", "411628");
		XZQHMAP.put("411729", "411729");
		...
		//==2014-01-07 接公安部电话后加入================//
		XZQHMAP.put("460100", "460100");
		XZQHMAP.put("460200", "460200");
	}
	...
	public static int getYHBMLevel(String userid) {
		if (userid == null || (userid.startsWith("MB")&&(userid.trim().length() != 20) && (userid.trim().length() != 17))) {// 传入空参数或参数位数不匹配
			return IConstants.ERRORLEVEL;
		}
		if(!userid.startsWith("MB")){
			//驾驶员或者押运员
	 ...
	 * create by zhaohuibin 2015-12-7 上午11:40:32
	 */
	public static String getFatherDwId(String userid) {
		 if (userid.substring(9, 17).equals("00000000")) {
			return userid.substring(0, 7)+"0000000000";
		} else if (userid.substring(11, 17).equals("000000")) {
			return userid.substring(0, 9)+"00000000";
		} else if (userid.substring(13, 17).equals("0000")) {
			return userid.substring(0, 11)+"000000";
		} else if (userid.substring(15, 17).equals("00")) {
			return userid.substring(0, 13)+"0000";
		} else {
			return userid;
		}
	}
	 ...
	 * @返回值：String
	 */
	public static String getDwidEndZero(int dwjb) {
		if (dwjb  == IConstants.YHBM_LEVEL_1) {
			return "0000000000";
		} else if (dwjb  == IConstants.YHBM_LEVEL_2) {
			return "00000000";
		} else if (dwjb  == IConstants.YHBM_LEVEL_3) {
			return "000000";
		} else if (dwjb  == IConstants.YHBM_LEVEL_4) {
			return "0000";
		} else {
			return "00";
		}
	 ...
	 * @返回值：String
	 */
	public static int  getDwidSubConut(int dwjb) {
		if (dwjb  == IConstants.YHBM_LEVEL_1) {
			return 7;
		} else if (dwjb  == IConstants.YHBM_LEVEL_2) {
			return 9;
	...
	public static void main(String[] arg){
		System.out.println(XzhqhUtils.isCountry("468200"));
	 ...
	 * 获取指定父级单位ID
	 * @参数：@param tsdwid
	 * @参数：@param yhbm_level_1
	 * @返回值：void
	 */
	public static String getDwidByLevel(String tsdwid, int yhbm_level_1) {
		int level = XzhqhUtils.getYHBMLevel(tsdwid);
		if(level != yhbm_level_1){
			tsdwid = getFatherDwId(tsdwid);
			return getDwidByLevel(tsdwid,yhbm_level_1);
		}
		return tsdwid;
