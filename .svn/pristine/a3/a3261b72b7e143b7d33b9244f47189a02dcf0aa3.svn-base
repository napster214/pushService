...
public class BakEmailUtils {

	private Properties properties = null;
	private String fromEmail = null;
	private String fromAuthCode = null;
	
	
	private BakEmailUtils() {};
	
	public static BakEmailUtils getInstance() {
		BakEmailUtils utils = new BakEmailUtils();
		...
		utils.fromEmail = SysProperUtils.getProperty("mail.from");// 发件人邮箱 
		utils.fromAuthCode = SysProperUtils.getProperty("mail.fromAuthCode");// 发件人认证信息
		return utils;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		emailBean.setEmails(new String[]{"18337127032@163.com","1017392558@qq.com"});
		AttachmentBean att1 = new AttachmentBean("C:\\Users\\Administrator\\Desktop\\sentinel.conf");
		AttachmentBean att2 = new AttachmentBean("C:\\Users\\Administrator\\Desktop\\kdinfo.properties");
		...
		BakEmailUtils.getInstance().sendEmail(emailBean);
	}
	 ...
	 * 发送邮件信息
	 */
	private void sendEmailTemplete(String[] emails, String subject, String content, 
	 ...
	 * 设置message信息
	 */
	private void fillMessage(Message message, String[] emails, String subject, String content, 
			String emailCc, String emailBcc, boolean isAtt, AttachmentBean[] atts) throws Exception {
	 ...
	 * 填充邮件内容信息
	 */
	private void fillContent(Message message, String content, 
